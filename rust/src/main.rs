...
fn main() {
    ...
    let mut all_quotes = vec![
        ...
        "Hey, just so you know: it's NOT that common, it DOESN'T happen to every guy, and it IS a big deal!","They're still not coming on man! And the lotion and the powder have made a paste!",
